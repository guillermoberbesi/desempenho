...
class TIPOUSUARIO extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('co_tipo_usuario, tipo_usuario', 'required'),
			array('tipo_usuario', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('co_tipo_usuario, tipo_usuario', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			 'pERMISSAOSISTEMAs' => array(self::HAS_MANY, 'PERMISSAOSISTEMA', 'co_tipo_usuario'),
		);
	}
